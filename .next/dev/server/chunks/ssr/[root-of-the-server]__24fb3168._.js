...
function GenerateCoursePage() {
    ...
    const generateRoadmap = async ()=>{
        ...
        try {
            ...
            // Modules yaratish
            const modules = aiRoadmap.map((m, index)=>({
            ...
            // Topics yaratish
            const topics = aiRoadmap.flatMap((m, moduleIndex)=>m.topics.map((t, topicIndex)=>({
                        id: crypto.randomUUID(),
...
async function generateAiRoadmap(course, userProfile) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__24fb3168._.js.map